...
# we're using a README.md, if you do not have this in your folder, simply replace this with a string.
...
setup(
    ...
    url='https://github.com/MaastrichtU-CDS/v6-gpu-accessibility',
